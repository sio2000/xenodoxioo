...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.hero.subtitle': 'Luxury villa rentals in Leonidion. Book your dream vacation today and experience authentic Greek hospitality.',
    ...
    'home.featured.subtitle': 'Handpicked villas offering the best in luxury and comfort',
    ...
    'home.trust.description': 'Since 2015, we\'ve been providing unforgettable vacation experiences in Leonidion. Join our growing community of satisfied travelers.',
    'home.cta.title': 'Ready to Plan Your Escape?',
    'home.cta.subtitle': 'Explore our beautiful properties and book your perfect getaway in Leonidion today.',
    ...
    'checkout.cvv': 'CVV',
    'checkout.agreeTerms': 'I agree to the Cancellation Policy and Terms of Service',
    'checkout.sendUpdates': 'Send me booking confirmation and important updates to my email',
    'checkout.completeBooking': 'Complete Booking',
    'checkout.depositNote': 'Only {amount} will be charged now. Remaining {balance} will be charged 30 days before arrival.',
  ...
  fr: {
    ...
    'home.hero.subtitle': 'Location de villas de luxe à Léonidion. Réservez vos vacances de rêve dès aujourd\'hui et vivez l\'hospitalité grecque authentique.',
    ...
    'home.featured.subtitle': 'Villas sélectionnées offrant le meilleur en luxe et confort',
    ...
    'home.trust.description': 'Depuis 2015, nous offrons des expériences de vacances inoubliables à Léonidion. Rejoignez notre communauté croissante de voyageurs satisfaits.',
    'home.cta.title': 'Prêt à planifier votre escapade?',
    'home.cta.subtitle': 'Explorez nos belles propriétés et réservez vos vacances parfaites à Léonidion dès aujourd\'hui.',
    ...
    'checkout.subtitle': 'Vérifiez vos informations et sécurisez votre réservation',
  ...
  de: {
    ...
    'home.hero.subtitle': 'Luxusvilla-Mietungen in Leonidion. Buche deinen Traumurlaub heute und erlebe authentische griechische Gastfreundschaft.',
    ...
    'home.featured.subtitle': 'Handverlesene Villen mit dem Besten an Luxus und Komfort',
    ...
    'home.trust.description': 'Seit 2015 bieten wir unvergessliche Urlaubserlebnisse in Leonidion. Treten Sie unserer wachsenden Gemeinschaft zufriedener Reisender bei.',
    'home.cta.title': 'Bereit, deinen Rückzugsort zu planen?',
    'home.cta.subtitle': 'Erkunde unsere wunderschönen Objekte und buche deinen perfekten Urlaub in Leonidion noch heute.',
    ...
    'checkout.subtitle': 'Überprüfe deine Daten und bestätige deine Reservierung',
  ...
  el: {
    ...
    'home.hero.subtitle': 'Ενοικίαση πολυτελών βιλών στη Λεωνίδιο. Κάντε κράτηση για τις διακοπές των ονείρων σας σήμερα και απολαύστε την αυθεντική ελληνική φιλοξενία.',
    ...
    'home.featured.subtitle': 'Επιλεγμένες βίλες που προσφέρουν το καλύτερο σε πολυτέλεια και άνεση',
    ...
    'home.trust.description': 'Από το 2015, παρέχουμε αξέχαστες εμπειρίες διακοπών στη Λεωνίδιο. Προσχωρήστε στην αυξανόμενη κοινότητα ικανοποιημένων ταξιδιωτών.',
    'home.cta.title': 'Έτοιμος να σχεδιάσεις τη διαφυγή σου;',
    'home.cta.subtitle': 'Εξερευνήστε τα όμορφα ακίνητά μας και κάντε κράτηση για τις τέλειες διακοπές σας στη Λεωνίδιο σήμερα.',
    ...
    'checkout.subtitle': 'Ελέγξτε τα στοιχεία σας και ασφαλίστε την κράτησή σας',
